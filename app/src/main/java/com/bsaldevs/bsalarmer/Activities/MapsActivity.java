...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private RecyclerView pointsRecycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutBottomSheet.getBackground().setAlpha(0);
        ...
        sheetBehavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                switch (newState) {
                    ...
                    case BottomSheetBehavior.STATE_EXPANDED: {
                        ((ImageView) findViewById(R.id.bottomSheetArrow)).setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_keyboard_arrow_down_24px));
                    }
                    break;
                    case BottomSheetBehavior.STATE_COLLAPSED: {
                        ((ImageView) findViewById(R.id.bottomSheetArrow)).setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_keyboard_arrow_up_24px));
                    }
                    break;
            ...
            public void onSlide(@NonNull View bottomSheet, float slideOffset) {
                layoutBottomSheet.getBackground().setAlpha((int) (255 * slideOffset));
                pointsRecycler.setAlpha(slideOffset);
            }
        });
        ...
        pointsRecycler = findViewById(R.id.pointsRecyclerView2);
        pointsRecycler.setLayoutManager(new LinearLayoutManager(this));
        pointsRecycler.setAdapter(new MyAdapter());
    ...
    public class MyAdapter extends RecyclerView.Adapter<MapsActivity.MyAdapter.PointViewHolder> {
        ...
        @Override
        public MapsActivity.MyAdapter.PointViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new MapsActivity.MyAdapter.PointViewHolder(v);
        }


        @Override
        public void onBindViewHolder(MapsActivity.MyAdapter.PointViewHolder holder, final int position) {
    ...
    private void showPointCreatingDialog(final LatLng latLng) {
        ...
        confirmStationName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                addTarget(point, id);
                pwlist.add(new PointWrapper(point));
                pointsRecycler.getAdapter().notifyItemInserted(pwlist.size() - 1);
                dialog.dismiss();
            }
        });
    }
